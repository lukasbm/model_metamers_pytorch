...
parser.add_argument('-F', '--FOLDER', metavar='--F', type=str, default='network_network_evaluations',
                    help='name of the folder to save network-network evaluations')
...
correct_incorrect_1000, average_correct_1000 = evaluate_predicted_vs_actual(
    prediction_dict['labels_1000_way_all_layers'],
...
bootstrap_sem_1000, bootstrap_sem_16 = bootstrap_imagenet_correct_incorrect(correct_incorrect_1000,
                                                                            correct_incorrect_16, num_bootstraps=1000)
