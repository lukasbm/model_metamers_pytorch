...
parser.add_argument('NUMSPLITS', metavar='--S', type=int, nargs='?', default=10,
                    help='Number of splits to run on the dataset')
parser.add_argument('RANDSEED', metavar='--D', type=int, nargs='?', default=3882,
                    help='Random seed to use for determining the splits')
parser.add_argument('OVERWRITE', metavar='--O', type=str2bool, nargs='?', const=True, default=False,
                    help='Force overwrite pickle files')
