...
def main(raw_args=None):
    ...
    parser.add_argument('-F', '--INPUTAUDIOFUNC', metavar='--A', type=str, default='psychophysics_wsj400_jsintest',
                        help='function to use for grabbing the input audio sources for the "time_average" layers')
    ...
    parser.add_argument('-E', '--NOISE_SCALE', metavar='--E', type=float, default=0.0000001,
    ...
    parser.add_argument('-S', '--STRICT', default=False, action='store_true',
                        help='set to true to enforce strict loading of model')
    parser.add_argument('-V', '--OVERRIDE_SAVE', action='store_true',
