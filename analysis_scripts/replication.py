...
def generate(image_id, model_name, output_name, seed):
    default_generation(
        image_id=image_id,
        model_directory=f"model_analysis_folders/visual_networks/{model_name}",
...
if __name__ == "__main__":
    ...
    generate(image_id=257, model_name="alexnet", output_name="257_alexnet_standard_my_fe_model_relu3", seed=seed)
