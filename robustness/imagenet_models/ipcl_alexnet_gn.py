"""
Model architecture from open_ipcl repository.

https://github.com/harvard-visionlab/open_ipcl

MIT License
Copyright (c) 2021 grez72

## Architecture modified by jfeather for metamer code compatability##
"""
...
def ipcl_alexnet_gn(pretrained=False, progress=True, layer_for_fc=None, config=None, **kwargs):
    """
    Alexnet architecture from open_ipcl repository
